...
> Current contract (2026-09-09): [Explicit record context](../specs/EXPLICIT_RECORD_CONTEXT.md) supersedes the `recordId` / `saveMode` activation rules below. The lifecycle protections still apply.
