...
| Where a failed mapping is retried from, and who may retry it                            | A Retry button on the submission, plus a Ready for Retry status for up to 50 at a time; only Failed and Ready for Retry are retried (D35, revised by D42) |
