import { sanitizeCustomCss } from 'c/zFormSanitizer';
...
export const FORM_LAYOUTS = [
    ...
    { value: 'splitSidebarImg', label: 'Split Sidebar Image' },
    { value: 'floatingCardSplit', label: 'Floating Card Split' },
    { value: 'splitBgOverlay', label: 'Split Background Overlay' },
    { value: 'asymmetricLanding', label: 'Asymmetric Landing Page' },
    { value: 'verticalStackedInfo', label: 'Vertical Stacked Informational' },
    { value: 'verticalStackedInputs', label: 'Vertical Stacked Inputs' },
    { value: 'multiStepWizard', label: 'Multi-Step Segmented Wizard' },
    { value: 'threeColumnDashboard', label: 'Three-Column Dashboard' },
    { value: 'focusModalPopup', label: 'Focus Modal Popup' },
    { value: 'multiCardGrid', label: 'Multi-Card Grid' }
];
...
export const LAYOUT_TEMPLATES = {
    ...
    splitSidebarImg: {
        name: 'splitSidebarImg', layout: 'splitSidebarImg', label: 'Split Sidebar Image', font: 'enterprise',
        accent: '#0176d3', surface: '#ffffff', pageBg: '#f8fafc',
        radius: 'rounded', cardShadow: 'soft', sectionDefault: 'plain', glass: false
    },
    floatingCardSplit: {
        name: 'floatingCardSplit', layout: 'floatingCardSplit', label: 'Floating Card Split', font: 'luxe',
        accent: '#c9a24b', surface: '#ffffff', pageBg: '#f3f4f6',
        radius: 'round', cardShadow: 'strong', sectionDefault: 'plain', glass: false
    },
    splitBgOverlay: {
        name: 'splitBgOverlay', layout: 'splitBgOverlay', label: 'Split Background Overlay', font: 'geometric',
        accent: '#0d9488', surface: '#ffffff', pageBg: '#e2e8f0',
        radius: 'rounded', cardShadow: 'soft', sectionDefault: 'plain', glass: false
    },
    asymmetricLanding: {
        name: 'asymmetricLanding', layout: 'asymmetricLanding', label: 'Asymmetric Landing Page', font: 'enterprise',
        accent: '#2563eb', surface: '#ffffff', pageBg: '#f8fafc',
        radius: 'rounded', cardShadow: 'medium', sectionDefault: 'card', glass: false
    },
    verticalStackedInfo: {
        name: 'verticalStackedInfo', layout: 'verticalStackedInfo', label: 'Vertical Stacked Informational', font: 'luxe',
        accent: '#1e293b', surface: '#ffffff', pageBg: '#ffffff',
        radius: 'rounded', cardShadow: 'soft', sectionDefault: 'plain', glass: false
    },
    verticalStackedInputs: {
        name: 'verticalStackedInputs', layout: 'verticalStackedInputs', label: 'Vertical Stacked Inputs', font: 'technical',
        accent: '#e6571f', surface: '#ffffff', pageBg: '#f5f5f4',
        radius: 'sharp', cardShadow: 'none', sectionDefault: 'boxed', glass: false
    },
    multiStepWizard: {
        name: 'multiStepWizard', layout: 'multiStepWizard', label: 'Multi-Step Segmented Wizard', font: 'geometric',
        accent: '#4f46e5', surface: '#ffffff', pageBg: '#fafafa',
        radius: 'round', cardShadow: 'soft', sectionDefault: 'plain', glass: false
    },
    threeColumnDashboard: {
        name: 'threeColumnDashboard', layout: 'threeColumnDashboard', label: 'Three-Column Dashboard', font: 'enterprise',
        accent: '#0284c7', surface: '#ffffff', pageBg: '#f1f5f9',
        radius: 'rounded', cardShadow: 'soft', sectionDefault: 'plain', glass: false
    },
    focusModalPopup: {
        name: 'focusModalPopup', layout: 'focusModalPopup', label: 'Focus Modal Popup', font: 'geometric',
        accent: '#e11d48', surface: 'rgba(255, 255, 255, 0.9)', pageBg: 'rgba(15, 23, 42, 0.65)',
        radius: 'round', cardShadow: 'strong', sectionDefault: 'plain', glass: true
    },
    multiCardGrid: {
        name: 'multiCardGrid', layout: 'multiCardGrid', label: 'Multi-Card Grid', font: 'technical',
        accent: '#10b981', surface: '#ffffff', pageBg: '#f8fafc',
        radius: 'rounded', cardShadow: 'soft', sectionDefault: 'card', glass: false
    }
};
...
export function themeVars(t) {
    ...
    const parts = [
        ...
        `--split-left-ratio: ${theme.splitLeftRatio || '30%'}`,
        `--split-right-ratio: ${theme.splitRightRatio || '70%'}`,
        `--form-page-bg-image: ${theme.pageBgImage || 'none'}`,
        `--form-card-bg-image: ${theme.cardBgImage || 'none'}`,
        `--form-header-bg-image: ${theme.headerBgImage || 'none'}`
    ];
    ...
    if (theme.customCss) {
        const sanitized = sanitizeCustomCss(theme.customCss);
        if (sanitized) {
